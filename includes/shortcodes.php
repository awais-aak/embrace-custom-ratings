...
function wp_rating_display($atts, $content = null) {
  ...
  $output .= '
      <div id="rating-arguments-' . $postId . '">
        <div class="rating-pro">
          <div class="pro-heading">' . __('Pro', 'embrace-rating') . '</div>
          <ul>';
  ...
  $output .= '
        ...
        <div class="rating-contra">
          <div class="contra-heading">' . __('Contra', 'embrace-rating') . '</div>
          <ul>';
  ...
  if (get_post_meta($postId, 'wp_rating_stars_check', true) === null) {
    ...
    $output .= '
    <div class="bottom">
      <div class="rating-result">' . __('Result:', 'embrace-rating') . '</div>
      <div class="star-rating" title="' . $stars . __(' of 5 stars', 'embrace-rating') . '">';
