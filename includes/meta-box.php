...
function wp_rating_add_custom_meta_box() {
  add_meta_box(
    'wp_rating_editor', // id
    __('Rating', 'embrace-rating'), // title
...
function wp_rating_editor($post) {
  ...
  $output = '
    <table class="form-table">
      <tbody>
        ...
        <tr>
          <th scope="row"><label for="wp_rating_shortcode">' . __('Shortcode', 'embrace-rating') . '</label></th>
          <td><input type="text" name="wp_rating_shortcode" value="[wp_rating id=\'' . $postID . '\']" readonly /></td>
        </tr>

        <tr>
          <th scope="row"><label for="wp_rating_title">' . __('Title', 'embrace-rating') . '</label></th>
          <td><input type="text" name="wp_rating_title" value="' . esc_html(get_post_meta($postID, 'wp_rating_title', true)) . '" /></td>
        </tr>

        <tr>
          <th scope="row"><label for="wp_rating_image">' . __('Image', 'embrace-rating') . '</label></th>
          <td><input type="text" name="wp_rating_image" id="rating_image" value="' . esc_html(get_post_meta($postID, 'wp_rating_image', true)) . '" />
          <input type="button" id="wp_rating_upload_button" value="' . __('Upload', 'embrace-rating') . '" />
        </td>
        </tr>

        <tr>
          <th scope="row"><label for="wp_rating_pro">' . __('Pro', 'embrace-rating') . '</label></th>
          <td><textarea name="wp_rating_pro" rows="5">' . esc_html(get_post_meta($postID, 'wp_rating_pro', true)) . '</textarea></td>
        </tr>

        <tr>
          <th scope="row"><label for="wp_rating_contra">' . __('Contra', 'embrace-rating') . '</label></th>
          <td><textarea name="wp_rating_contra" rows="5">' . esc_html(get_post_meta($postID, 'wp_rating_contra', true)) . '</textarea></td>
        </tr>

        <tr>
          <th scope="row"><label for="wp_rating_stars_check">' . __('Enable Star Rating', 'embrace-rating') . '</label></th>
  ';
  ...
  $output	.= '
        ...
        <tr>
          <th scope="row"><label for="wp_rating_percent">' . __('Rating in %', 'embrace-rating') . '</label></th>
          <td><input type="text" name="wp_rating_percent" value="' . esc_html(get_post_meta($postID, 'wp_rating_percent', true)) . '" /></td>
        </tr>

        <tr>
          <th scope="row"><label for="wp_rating_button_background_color">' . __('Button Background Color', 'embrace-rating') . '</label></th>
        ...
        <tr>
          <th scope="row"><label for="wp_rating_button_text">' . __('Button Text', 'embrace-rating') . '</label></th>
          <td><input type="text" name="wp_rating_button_text" value="' . esc_html(get_post_meta($postID, 'wp_rating_button_text', true)) . '" /></td>
        </tr>

        <tr>
          <th scope="row"><label for="wp_rating_button_link">' . __('Button Link', 'embrace-rating') . '</label></th>
